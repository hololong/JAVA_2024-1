...
public class DB_Insert {
	...
	public static void main(String[] args) {
		...
		String id = "root";  // DB에 로그인 할 ID
		String pw = "1234";  // MYSQL 설정 시 입력한 PASSWORD
		
		// statement : SQL문 실행하기 위해 사용하느 클래스.
		...
		try {
			...
			// 3단계 : SQL 문 전송 & 4단계 : 결과받기
			stmt.executeUpdate("insert into student (NAME, Dept, ID) values ('임서윤', '컴퓨터공학부', '202195033');");
